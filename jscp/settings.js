...
let settings = {
    ...
    sequence: 'YOU|ARE|ALWAYS|BEAUTIFUL|AYAZHAN|❤',
    ...
    pages: [
        ...
        { 
            image: './image/photos/ayazhan1.jpg',
        },

        // --- Lembar 2 (data-page="1") ---
        { 
            image: './image/photos/ayazhan2.jpg',
            content: 'С Днём Рождения, AYAZHAN 💗' 
        },
        { 
            image: './image/photos/ayazhan3.jpg',
        },

        // --- Lembar 3 (data-page="2") ---
        { 
            image: './image/photos/ayazhan4.jpg',
            content: 'Ты самая красивая ✨'
        },
        {
            image: './image/photos/ayazhan5.jpg',
        },

        // --- Lembar 4 (data-page="3") ---
        { 
            image: './image/theend.jpg',
            content: '.' 
        }
...
function initializeDefaultSettings() {
    ...
    window.settings = {
        ...
        pages: [
            ...
            { 
                image: './image/photos/ayazhan2.jpg',
                content: 'You are so beautiful, AYAZHAN' 
            },
            { 
                image: './image/photos/ayazhan3.jpg',
            },
